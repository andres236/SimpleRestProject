...
public class ActivityClient {
	...
	public Activity get(String id){
		...
		//String response = target.path("activities/" + id).request(MediaType.APLICATION_JSON).get(String.class);
	...
	public List<Activity> get() {
		...
		//List<Activity> response = target.path("activities").request(MediaType.APPLICATION_JSON).get(List.class);// not supported
