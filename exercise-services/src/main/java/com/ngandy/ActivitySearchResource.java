...
public class ActivitySearchResource {
	...
	//IF we got a real implementation, throw away the stub and use 
	//Hibernation implementation or JPA or just straight JDBC
	...
	@GET
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	public Response searchForAcitvity(@QueryParam(value= "description") List<String> descriptions, 
